...
class PacketTest {
    ...
    //         var ret1 =
    //                 new PNPResult(new Transform3d(new Translation3d(1, 2, 3), new Rotation3d(1, 2,
    // 3)), 0.1);
    ...
    //                         new PNPResult(
    //                                 new Transform3d(new Translation3d(1, 2, 3), new Rotation3d(1,
    // 2, 3)), 0.1),
    ...
    //                                         -1,
    //                                         -1f,
    //                                         new Transform3d(new Translation3d(1, 2, 3), new
    // Rotation3d(1, 2, 3)),
    //                                         new Transform3d(new Translation3d(1, 2, 3), new
    // Rotation3d(1, 2, 3)),
    //                                         0.25,
    ...
    //                                         -1,
    //                                         -1f,
    //                                         new Transform3d(new Translation3d(4, 2, 3), new
    // Rotation3d(1, 5, 3)),
    //                                         new Transform3d(new Translation3d(4, 2, 3), new
    // Rotation3d(1, 5, 3)),
    //                                         0.25,
